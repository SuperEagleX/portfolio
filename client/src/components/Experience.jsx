...
const JOBS = [
  {
    ...
    current: true,
    bullets: [
      'Conduct vulnerability assessments across internal systems and banking infrastructure using Tenable Nessus, triaging findings by CVSS severity and tracking remediation to closure',
      'Perform web application penetration tests against internal and customer-facing platforms, uncovering critical vulnerabilities including SQL Injection that posed direct risk to sensitive financial data',
      'Orchestrate email phishing simulation campaigns using GoPhish to measure employee susceptibility, report click-through metrics to management, and drive targeted security awareness training',
      'Execute network infrastructure assessments across segmented VLANs and core banking subnets, uncovering misconfigurations that reduced the network attack surface',
      'Deliver detailed VAPT reports with CVSS-scored findings, proof-of-concept exploits, and actionable remediation roadmaps for stakeholders',
    ],
  },
  {
    id: 2,
